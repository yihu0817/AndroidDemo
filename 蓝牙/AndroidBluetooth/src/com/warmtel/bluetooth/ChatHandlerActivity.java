...
import com.warmtel.bluetooth.service.BlueClientHandlerService.IBluetoothSerivice;
import com.warmtel.bluetooth.util.Constances;
import com.warmtel.bluetooth.util.Logs;

@SuppressLint({ "NewApi", "HandlerLeak" })
public class ChatHandlerActivity extends Activity implements OnClickListener {
	...
	public static void actionServerChatActivity(Context context) {
		Intent intent = new Intent(context, ChatHandlerActivity.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bindService(new Intent(this, BlueClientHandlerService.class), mBluetoothConnectService, BIND_AUTO_CREATE);
	}
